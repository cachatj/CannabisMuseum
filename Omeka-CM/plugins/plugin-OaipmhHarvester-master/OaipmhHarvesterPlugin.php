...
defined('OAIPMH_HARVESTER_PLUGIN_DIRECTORY') 
    or define('OAIPMH_HARVESTER_PLUGIN_DIRECTORY', dirname('/home3/wirtsha1/public_html/cannabismuseum/omeka/plugins/OaipmhHarvester-master'));

// /** Path to plugin maps directory */
// defined('OAIPMH_HARVESTER_MAPS_DIRECTORY') 
//     or define('OAIPMH_HARVESTER_MAPS_DIRECTORY', '/home3/wirtsha1/public_html/cannabismuseum/omeka/plugins/OaipmhHarvester/models/OaipmhHarvester/Harvest');

// require_once dirname('/home3/wirtsha1/public_html/cannabismuseum/omeka/plugins/OaipmhHarvester/functions.php')
