<?php
class Reports_Generator_PdfQrCode_QuickCharts
{
    /**
     * The URL of the QuickCharts chart API, used to generate the QR codes
     */
    const CHART_API_URI = 'https://quickchart.io/chart';
    ...
    public function generate($data)
    {
        ...
        if ($response->isSuccessful()) {
            ...
            throw new Zend_Http_Client_Exception(
                "Could not retrieve QR chart from QuickCharts."
            );
        }
    }

    /**
     * Generate a URI to a QR code for the specified item using the QuickCharts
     * Chart API.
     *
